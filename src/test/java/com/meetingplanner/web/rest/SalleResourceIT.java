...
class SalleResourceIT {
    ...
    public static Salle createEntity(EntityManager em) {
        Salle salle = new Salle().nom(DEFAULT_NOM).capacite(DEFAULT_CAPACITE);
        return salle;
    }
    ...
    public static Salle createUpdatedEntity(EntityManager em) {
        Salle salle = new Salle().nom(UPDATED_NOM).capacite(UPDATED_CAPACITE);
        return salle;
    }
    ...
    void putNewSalle() throws Exception {
        ...
        updatedSalle.nom(UPDATED_NOM).capacite(UPDATED_CAPACITE);
    ...
    void fullUpdateSalleWithPatch() throws Exception {
        ...
        partialUpdatedSalle.nom(UPDATED_NOM).capacite(UPDATED_CAPACITE);
